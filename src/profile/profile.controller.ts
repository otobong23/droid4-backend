...
export class ProfileController {
  ...
  async verificationStatus(
    @Req() req,
    @Body('verificationStatus') verificationStatus: 'pending' | 'verified',
  ) {
    return this.profileService.updateVerification(
      req.user.email,
      verificationStatus,
    );
  }
  ...
  async KYCVerificationStatus(
    @Req() req,
    @Body('KYCVerificationStatus')
    KYCVerificationStatus: 'pending' | 'verified',
  ) {
    return this.profileService.updateKYCVerificationStatus(
      req.user.email,
