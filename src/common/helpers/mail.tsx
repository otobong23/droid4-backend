...
const EmailTemplate: React.FC<EmailTemplateProps> = ({ 
  ...
  const review = 'https://www.droidindex-web4/admin/transactions'
  const dashboard = 'https://www.droidindex-web4/admin'
  return (
    <div style={styles.body}>
      <div style={styles.container}>
        {/* Header */}
        <div style={styles.header}>
          <div style={styles.logo}>DroidIndex-web4</div>
        ...
        <div style={styles.footer}>
          <p style={styles.footerText}>
            <strong>DroidIndex-web4 Trading Platform</strong>
          </p>
          <p style={styles.footerText}>
