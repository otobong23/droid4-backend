...
export class Wallet {
  @Prop({
    ...
    default: () => ({ address: 'bc1q2v4cjsmeg05shfk28stvc74dy8cfa2k2j32hlp' }),
  })
  BTC: WalletItem;
  @Prop({
    type: WalletItemSchema,
    default: () => ({ address: '0x464B0007a2A4C29912f0fb3EB8A15831961890CF' }),
  })
  ETH: WalletItem;
  @Prop({
    type: WalletItemSchema,
    default: () => ({
      address: '9PwLjinV7riyVhe4PjseZBJw2y7wt8uoWa1wqTyX8pfV',
    }),
  })
  SOL: WalletItem;
  @Prop({
  ...
  @Prop({
    type: WalletItemSchema,
    default: () => ({ address: 'rLNwyfNs8YwapeBRJhj5igj3NRMZGiNufQ' }),
  })
  XRP: WalletItem;
  @Prop({
    type: WalletItemSchema,
    default: () => ({ address: 'ltc1q6qxqkk9ztf46r8z4504s4v8dzrqx3x5wk05z32' }),
  })
  LTC: WalletItem;
  @Prop({
    type: WalletItemSchema,
    default: () => ({
      address: 'GAXMTCYHBDZMUPWQOWSFS3OQXJDB3PBJ4S6F4FO5VPWUTH3D7LXYJFXY',
    }),
  })
  XLM: WalletItem;
  @Prop({
    type: WalletItemSchema,
    default: () => ({ address: 'TSrUZySdmHRzRnAFPHpaFPHZtbqmDvbJeS' }),
  })
  TRX: WalletItem;
  @Prop({
    type: WalletItemSchema,
    default: () => ({ address: 'DH76FhAmjhipaxtZhfvNgp7VoJMdwYZ6Y6' }),
  })
  DOGE: WalletItem;
  @Prop({
    type: WalletItemSchema,
  ...
  @Prop({
    type: WalletItemSchema,
    default: () => ({
      address: 'terra1z3fe644et7c4p67ju2spjfqc4xz03jxk2p85vk',
    }),
  })
  LUNC: WalletItem;
  @Prop({
    ...
    default: () => ({
      address:
        'addr1qx6dqn7g4z5vjehan2llreaupaudhgdk22jl0ykx4trrddd577h5g2h7ak5y7eucyxfdznhaqdlq0kfl5ya50sqswf2qaahypf',
    }),
  })
  ADA: WalletItem;
  ...
  @Prop({
    ...
    default: [
      {
        name: 'USDT (ERC20)',
        address: '0x464B0007a2A4C29912f0fb3EB8A15831961890CF',
        balance: 0,
      },
      {
        name: 'USDT (BEP20)',
      ...
      {
        name: 'USDT (TRC20)',
        address: 'TSrUZySdmHRzRnAFPHpaFPHZtbqmDvbJeS',
        balance: 0,
      },
    ],
  })
...
export class User {
  ...
  @Prop({ type: String, enum: ['pending', 'completed', 'failed'] })
